    ...
    private fun addPropertyNotificationFromCharacteristic(
        ...
        if ((characteristic.properties and BluetoothGattCharacteristic.PROPERTY_NOTIFY) != 0) {
            ...
            if (isNotificationEnable) {
                propertyAction.setBackgroundColor(ContextCompat.getColor(context, R.color.light_grey))
                ...
                propertyAction.setTextColor(ContextCompat.getColor(context, R.color.light_grey))
            }
            propertyAction.setOnClickListener {
